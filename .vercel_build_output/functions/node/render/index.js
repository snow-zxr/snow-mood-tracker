...
// .svelte-kit/output/server/chunks/db-5e2acae9.js
var import_supabase_js, supabase;
var init_db_5e2acae9 = __esm({
  ".svelte-kit/output/server/chunks/db-5e2acae9.js"() {
    init_shims();
    import_supabase_js = __toModule(require_main5());
    supabase = (0, import_supabase_js.createClient)("https://zdquzuzxfuvdlkenpsbq.supabase.co", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2xlIjoiYW5vbiIsImlhdCI6MTYzODY5NDU3MiwiZXhwIjoxOTU0MjcwNTcyfQ.3w3Zuvmg1AQlzs-XmW7plUD35Hstk_JPceCOTK21LYk");
  }
});

// .svelte-kit/output/server/chunks/__layout-56b33634.js
var layout_56b33634_exports = {};
__export(layout_56b33634_exports, {
  default: () => _layout
});
var css, Navbar, getStores, page, error, session, _layout;
var init_layout_56b33634 = __esm({
  ".svelte-kit/output/server/chunks/__layout-56b33634.js"() {
    init_shims();
    init_app_830e099a();
    init_db_5e2acae9();
    css = {
      code: "a.svelte-1l2q0vq{font-family:'MV Boli'}",
      map: null
    };
    Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css);
      return `<nav class="${"navbar navbar-expand-xl navbar-dark bg-dark"}"><div class="${"container-fluid"}"><a class="${"navbar-brand svelte-1l2q0vq"}" href="${"#"}">My Mood Tracker\u{1F642}</a>
    <button class="${"navbar-toggler"}" type="${"button"}" data-bs-toggle="${"collapse"}" data-bs-target="${"#navbarDark"}" aria-controls="${"navbarDark"}" aria-expanded="${"false"}" aria-label="${"Toggle navigation"}"></button></div>
</nav>`;
    });
    getStores = () => {
...
// .svelte-kit/output/server/chunks/error-71ddd61d.js
var error_71ddd61d_exports = {};
__export(error_71ddd61d_exports, {
  default: () => Error2,
  load: () => load
});
...
// .svelte-kit/output/server/chunks/index-ad3a836d.js
var index_ad3a836d_exports = {};
__export(index_ad3a836d_exports, {
  default: () => Routes
});
var css$1, Greeting, Entry, EntryModal, css2, Routes;
var init_index_ad3a836d = __esm({
  ".svelte-kit/output/server/chunks/index-ad3a836d.js"() {
    init_shims();
    init_app_830e099a();
    init_db_5e2acae9();
    css$1 = {
      code: "h1.svelte-1nqyd9{font-family:fantasy}p.svelte-1nqyd9{font-family:'Comic Sans MS', cursive}",
      map: null
    };
    Greeting = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css$1);
      return `<section class="${"container px-4 pt-3"}"><h1 class="${"svelte-1nqyd9"}">Welcome</h1>
    <p class="${"svelte-1nqyd9"}">How are you feeling today?</p>
</section>`;
    });
    ...
    EntryModal = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<div class="${"modal fade"}" id="${"newEntry"}" tabindex="${"-1"}"><div class="${"modal-dialog modal-dialog-centered modal-dialog-scrollable"}"><div class="${"modal-content"}"><div class="${"modal-header"}"><h5 class="${"modal-title"}">New Entry</h5>
			...
			<div class="${"row px-5"}"><div class="${"btn-group mt-2 mb-3"}" role="${"group"}">
					<input type="${"radio"}" class="${"btn-check"}" name="${"moodRadio"}" id="${"worst"}" autocomplete="${"off"}">
					...
					<input type="${"radio"}" class="${"btn-check"}" name="${"moodRadio"}" id="${"okay"}" autocomplete="${"off"}">
			...
			<div class="${"form-floating"}"><textarea class="${"form-control"}" id="${"comment"}">${comment}</textarea>
    ...
    css2 = {
      code: "section.svelte-13bxcvb{background-color:#c9c0bb}div.svelte-13bxcvb{background-color:#838996}",
      map: null
    };
    Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      $$result.css.add(css2);
      return `<div class="${"svelte-13bxcvb"}">${validate_component(Greeting, "Greeting").$$render($$result, {}, {}, {})}


<section class="${"container px-4 py-3 svelte-13bxcvb"}"><div class="${"d-flex justify-content-between svelte-13bxcvb"}"><div class="${"p-2 font-monospace svelte-13bxcvb"}">Mood Log</div>
   	 <input class="${"btn btn-light mb-2"}" type="${"button"}" value="${"+ New Entry"}" data-bs-toggle="${"modal"}" data-bs-target="${"#newEntry"}"></div>

    <div class="${"list-group mb-3 svelte-13bxcvb"}">
    ${function(__value) {
...
${validate_component(EntryModal, "EntryModal").$$render($$result, {}, {}, {})}</div>


<section class="${"container px-4 py-3 text-center svelte-13bxcvb"}"><button class="${"btn btn-secondary"}">Logout</button>
</section>`;
    });
  }
});

// .svelte-kit/output/server/chunks/login-c988546a.js
var login_c988546a_exports = {};
__export(login_c988546a_exports, {
  default: () => Login
});
var Login;
var init_login_c988546a = __esm({
  ".svelte-kit/output/server/chunks/login-c988546a.js"() {
    init_shims();
    init_app_830e099a();
    init_db_5e2acae9();
    Login = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<div class="${"card mt-5 m-auto text-center"}" style="${"width: 24em;"}"><div class="${"card-body"}"><h5 class="${"card-title"}">Welcome</h5>
   	 ...
   	 <form class="${"form-floating"}"><form><label for="${"floatingInput"}">Email address</label>
   	        <input class="${"form-control"}" id="${"email"}" type="${"email"}"${add_attribute("value", email, 0)}>

   		    <button type="${"submit"}" class="${"btn btn-dark mt-3"}">Magic</button></form></form></div></div>`;
    });
  }
});

// .svelte-kit/output/server/chunks/app-830e099a.js
...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-a2b79b49.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-a2b79b49.js", assets + "/_app/chunks/vendor-9fc60af8.js", assets + "/_app/chunks/singletons-12a22614.js"]
    },
    fetched: void 0,
    floc: false,
...
var __accessCheck, __privateGet, __privateAdd, __privateSet, _map, chars, unsafeChars, reserved, escaped$1, objectProtoOwnPropertyNames, subscriber_queue, escape_json_string_in_html_dict, escape_html_attr_dict, s$1, s, absolute, ReadOnlyFormData, current_component, escaped, missing_component, on_destroy, css3, Root, base, assets, user_hooks, template, options, default_settings, empty, manifest, get_hooks, module_lookup, metadata_lookup;
var init_app_830e099a = __esm({
  ".svelte-kit/output/server/chunks/app-830e099a.js"() {
    init_shims();
...
${``}`;
    ...
    module_lookup = {
      "src/routes/__layout.svelte": () => Promise.resolve().then(() => (init_layout_56b33634(), layout_56b33634_exports)),
      ".svelte-kit/build/components/error.svelte": () => Promise.resolve().then(() => (init_error_71ddd61d(), error_71ddd61d_exports)),
      "src/routes/index.svelte": () => Promise.resolve().then(() => (init_index_ad3a836d(), index_ad3a836d_exports)),
      "src/routes/login.svelte": () => Promise.resolve().then(() => (init_login_c988546a(), login_c988546a_exports))
    };
    metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-33f111c8.js", "css": ["assets/pages/__layout.svelte-194fcf81.css"], "js": ["pages/__layout.svelte-33f111c8.js", "chunks/vendor-9fc60af8.js", "chunks/db-922c3b36.js", "chunks/singletons-12a22614.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-ea945fae.js", "css": [], "js": ["error.svelte-ea945fae.js", "chunks/vendor-9fc60af8.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-c640b5a9.js", "css": ["assets/pages/index.svelte-b4aaf4f5.css"], "js": ["pages/index.svelte-c640b5a9.js", "chunks/vendor-9fc60af8.js", "chunks/db-922c3b36.js"], "styles": [] }, "src/routes/login.svelte": { "entry": "pages/login.svelte-819cae5d.js", "css": [], "js": ["pages/login.svelte-819cae5d.js", "chunks/vendor-9fc60af8.js", "chunks/db-922c3b36.js"], "styles": [] } };
  }
});
