   	 ...
   	 <div class="modal-content">
			...
			<div class="row">
				...
				<form class="form-floating">
					<input type="number" class="form-control" id="dayInput" bind:value={day} value="1" min="1" max="31" />
					<label for="dayInput">Day</label>
				</form>
				</div>
				<div class="col">
				<form class="form-floating">
					<input type="number" class="form-control" id="monthInput" bind:value={month} value="1" min="1" max="12" />
					<label for="monthInput">Month</label>
				</form>
				</div>
				<div class="col">
				<form class="form-floating">
					<input type="number" class="form-control" id="yearInput" bind:value={year} value="2021" min="2021" />
